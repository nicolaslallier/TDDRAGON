"""
Unit tests for demo_api main module.
...
class TestRunMigrations:
    ...
    @pytest.mark.unit
    @patch("src.endpoints.demo_api.main.subprocess.run")
    @patch("src.endpoints.demo_api.main.os.chdir")
    @patch("src.endpoints.demo_api.main.os.path.dirname")
    @patch("src.endpoints.demo_api.main.os.path.abspath")
    def test_run_migrations_success_logs_info(
        ...
        mock_dirname.return_value = "/path/to/demo_api"
...
class TestLifespan:
    ...
    @pytest.mark.unit
    @patch("src.endpoints.demo_api.main.run_migrations")
    @patch("src.endpoints.demo_api.main.init_database")
    @patch("src.endpoints.demo_api.main.os.getenv")
    def test_lifespan_development_mode_runs_migrations(
        self, mock_getenv, mock_init_db, mock_run_migrations
    ):
    ...
    @patch("src.endpoints.demo_api.main.init_database")
    @patch("src.endpoints.demo_api.main.os.getenv")
    def test_lifespan_production_mode_skips_migrations(
        self, mock_getenv, mock_init_db, mock_run_migrations
    ):
